...
export function RegisterForm() {
  ...
  return (
    <form className="max-w-md mx-auto" onSubmit={handleSubmit(onSubmit)}>
      <label
        className="block mb-2 mt-5 text-md font-medium text-black"
        htmlFor="fullname"
      >
        {" "}
        Nombre completo{" "}
      ...
      <label
        className="block mb-2 mt-2 text-md font-medium text-black"
        htmlFor="birthDate"
      >
        Fecha de nacimiento
      </label>
      ...
      <select
        className="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5"
        id="gender"
        {...register("gender")}
      >
        {genderOptions}
      ...
      <div className="flex flex-col justify-center items-center">
        <button
          type="submit"
          className="block w-1/3 text-black font-semibold bg-amber-300 hover:bg-sky-400 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-sm px-5 py-2 mt-6"
        >
          Registrarse
        </button>
      </div>
